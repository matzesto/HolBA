...
(*
 * As described in the "Automating Information Flow Analysis of Low Level Code"
 * paper by Balliu et al., we initialize the symbolic state as follows:
 *
 * Environment: Mapping all registers to fresh symbolic Variables
 * Memory: Symbolic Memory Expression
 * PC: Constatnt PC value
 *)
 ...
 * TODO: better to assign ALL registers to symbolic values rather than onlyhe
 * ones used? *)
